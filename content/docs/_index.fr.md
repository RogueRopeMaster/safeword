...
3. [**Buffet Volunteers**](buffet-volunteers/) — Garder le buffet rempli, propre et accueillant pendant la soirée.
4. [**Assemblers**](assemblers/) — Installer l'espace avant l'ouverture.
5. [**Disassemblers**](disassemblers/) — Remettre l'espace en ordre après la fermeture.
...
Tu hésites sur le rôle qui te convient, ou tu as des questions ? Écris-nous via la [page contact](../contact/).
